                ...
                .appendHTML()
                    .html {
                        head {
                            ...
                            link {rel=LinkRel.stylesheet; href="/webjars/bootstrap/5.0.0/css/bootstrap.min.css"; media = LinkMedia.screen}
                        }
                        body {
                            div {
                            ...
                            script { src = "/webjars/bootstrap/5.0.0/js/bootstrap.min.js" }
                        }
                    }
